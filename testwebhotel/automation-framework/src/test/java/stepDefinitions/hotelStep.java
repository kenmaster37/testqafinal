...
public class hotelStep {
    ...
    private WebElement hotelEconomico = null;
        // Removed driver and base_po as instance variables


    @Given("el usuario navega a la página de hoteles")
    public void i_access_the_webdriver_university_login_page() {
    WebDriver driver = DriverFactory.getDriver();
    Base_PO base_po = new Base_PO(driver);
    ...
    public void aplicarFiltros() throws InterruptedException {
        ...
        actions.clickAndHold(nightRateSlider).moveByOffset(300, 0).release().perform();
    ...
    public void validarMensaje() {
        ...
        // No cerrar el driver aquí, el hook @After lo hace
    }
}
