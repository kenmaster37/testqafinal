...
public class Contact_Us_PO extends Base_PO {
    ...
    WebElement unsuccessfulSubmission_Message_Text;
    ...
    public void validate_Unsuccessful_SubmissionMessage_Text() {
        waitFor(unsuccessfulSubmission_Message_Text);
        Assert.assertEquals(unsuccessfulSubmission_Message_Text.getText(), "Error: Invalid email address"); //que hay de malo acá?
    }
